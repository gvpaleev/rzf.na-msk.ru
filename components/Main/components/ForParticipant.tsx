...
export const ForParticipant: FC = () => (
  <MainBlock title='Участнику' color={Colors.BLUE}>
    <form action="#" method='GET' autoComplete='off'>
      <div className='flex flex-col gap-y-5'>
        ...
        <div>
          ...
          <select id="region" className="py-4 bg-gray-50 border border-gray-300 text-gray-400 text-sms rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            <option selected>Выберете район</option>
        ...
        <div>
          ...
          <select id="metro" className="py-4 bg-gray-50 border border-gray-300 text-gray-400 text-sms rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            <option selected>Выберете метро</option>
    ...
    <Image className='mx-auto my-5' src='line_groups.svg' width={14} height={333} alt='more groups' />
