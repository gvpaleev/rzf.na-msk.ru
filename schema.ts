...
export interface paths {
  ...
  "/service-meetings/": {
    /** Представление возвращает все рабочие собрания на местности или в регионе РЗФ */
    get: operations["service-meetings_list"];
    parameters: {};
  };
  "/service-regions/": {
  ...
  "/today-service-meetings/": {
    /** Представление возвращает рабочие собрания сегодня на местности или в регионе РЗФ */
    get: operations["today-service-meetings_list"];
    parameters: {};
  };
  "/token/": {
    /**
...
export interface definitions {
  ...
  ScheduledMeeting: {
    ...
    committee?: definitions["Committee"];
    /** Продолжительность */
    duration?: string;
    /** Время начала */
    time: string;
