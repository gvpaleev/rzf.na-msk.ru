...
export const newcomerLinks: Array<LinkEntryParams> = [
  ...
  { url: '/meetings-today', title: 'Собрания сегодня', id: '4' },
  { url: '/info-adults', title: 'Информация для родственников', id: '5' },
]

export const participantLinks: Array<LinkEntryParams> = [
  { url: '/meetings-today', title: 'Собрания сегодня', id: '1' },
  { url: '/all-meetings', title: 'Все собрания', id: '2' },
  { url: '/meditation-today', title: 'Ежедневник', id: '3' },
  { url: '/principles', title: 'Принципы сообщества', id: '4' },
]
